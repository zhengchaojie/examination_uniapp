<template>
	<view class="u-select">
		...
		<u-popup :maskCloseAble="maskCloseAble" mode="bottom" :popup="false" :show="value" length="auto" :safeAreaInsetBottom="safeAreaInsetBottom" @close="close" :z-index="uZIndex">
			<view class="u-select">
